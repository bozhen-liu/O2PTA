; ModuleID = 'zipper_dataflow_bulb_class.cpp'
source_filename = "zipper_dataflow_bulb_class.cpp"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%"class.std::ios_base::Init" = type { i8 }
%class.LightBulb = type { i8, i32 }
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_zipper_dataflow_bulb_class.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_ZN9LightBulb9setStatusEb(%class.LightBulb* %5, i1 zeroext %12)
  %13 = call i32 @_ZNK9LightBulb12getIntensityEv(%class.LightBulb* %5)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_zipper_dataflow_bulb_class.cpp() #0 section ".text.startup" {
