; ModuleID = 'zipper_directflow_class.cpp'
source_filename = "zipper_directflow_class.cpp"
...
%class.Person = type { %"class.std::__cxx11::basic_string", %"class.std::__cxx11::basic_string" }
...
$_ZN6Person7setNameENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE = comdat any

$_ZN6Person5getIDB5cxx11Ev = comdat any

$_ZN6PersonD2Ev = comdat any

$_ZN6Person8updateIDEv = comdat any
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_zipper_directflow_class.cpp, i8* null }]
...
17:                                               ; preds = %16
  %18 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0))
          to label %19 unwind label %57

19:                                               ; preds = %17
  %20 = getelementptr inbounds %class.Person, %class.Person* %2, i32 0, i32 0
  %21 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE(%"class.std::basic_ostream"* dereferenceable(272) %18, %"class.std::__cxx11::basic_string"* dereferenceable(32) %20)
          to label %22 unwind label %57

22:                                               ; preds = %19
  %23 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %21, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i64 0, i64 0))
          to label %24 unwind label %57

24:                                               ; preds = %22
  %25 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE(%"class.std::basic_ostream"* dereferenceable(272) %23, %"class.std::__cxx11::basic_string"* dereferenceable(32) %8)
...
28:                                               ; preds = %26
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %10, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0), %"class.std::allocator"* dereferenceable(1) %11)
...
32:                                               ; preds = %31
  %33 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.4, i64 0, i64 0))
          to label %34 unwind label %73

34:                                               ; preds = %32
  %35 = getelementptr inbounds %class.Person, %class.Person* %9, i32 0, i32 0
  %36 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE(%"class.std::basic_ostream"* dereferenceable(272) %33, %"class.std::__cxx11::basic_string"* dereferenceable(32) %35)
          to label %37 unwind label %73

37:                                               ; preds = %34
  %38 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %36, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i64 0, i64 0))
          to label %39 unwind label %73

39:                                               ; preds = %37
  %40 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE(%"class.std::basic_ostream"* dereferenceable(272) %38, %"class.std::__cxx11::basic_string"* dereferenceable(32) %13)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_zipper_directflow_class.cpp() #0 section ".text.startup" {
