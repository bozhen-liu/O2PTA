; ModuleID = 'zipper_dataflow_library_class.cpp'
source_filename = "zipper_dataflow_library_class.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_zipper_dataflow_library_class.cpp, i8* null }]
...
13:                                               ; preds = %12
  %14 = invoke i32 @_ZNK4Book5getIDEv(%class.Book* %2)
          to label %15 unwind label %25

15:                                               ; preds = %13
  store i32 %14, i32* %7, align 4
  call void @_ZN4BookC2Ev(%class.Book* %8) #3
...
16:                                               ; preds = %15
  ...
  invoke void @_ZN4Book8setTitleERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(%class.Book* %8, %"class.std::__cxx11::basic_string"* dereferenceable(32) %9)
          to label %17 unwind label %33

17:                                               ; preds = %16
  %18 = invoke i32 @_ZNK4Book5getIDEv(%class.Book* %8)
...
19:                                               ; preds = %17
  ...
  call void @_ZN4BookD2Ev(%class.Book* %8) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_zipper_dataflow_library_class.cpp() #0 section ".text.startup" {
